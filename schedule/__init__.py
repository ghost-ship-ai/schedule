...
class Scheduler:
    ...
    async def async_run_pending(self) -> None:
        ...
        awaited, while sync jobs will be run normally.
...
class AsyncScheduler(Scheduler):
    """
    An async-first scheduler that provides async versions of all scheduling methods.

    This scheduler is designed for use in async environments where you want to
    run both sync and async jobs using async/await syntax.
    """
